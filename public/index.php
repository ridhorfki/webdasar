                    ...
                    if ($result = mysqli_query($conn, $sql)) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-small btn-warning" href="edit.php?id=<?= $row['nim'] ?>"> Edit</a>|
                                    <a class="btn btn-small btn-danger" href="hapus.php?id=<?= $row['nim'] ?>">Hapus</a>
                                </td>
                            </tr>
                            <?php
                        }
